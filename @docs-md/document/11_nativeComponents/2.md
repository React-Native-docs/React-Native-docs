...
앱에 동적인 Map을 추가한다고 가정해봅시다. [MKMapView]((https://developer.apple.com/library/prerelease/mac/documentation/MapKit/Reference/MKMapView_Class/index.html)) 를 사용하는 경우, JavaScript에서만 사용할 수 있으면 됩니다. 
