...
## The JS API[#](https://reactnative.dev/docs/headless-js-android#the-js-api)
...
## The Java API[#](https://reactnative.dev/docs/headless-js-android#the-java-api)
...
## Caveats[#](https://reactnative.dev/docs/headless-js-android#caveats)
