...
export default PageSectionList = (props) => {
	return (
...
| ItemSeparator *Component* | component, *element* | Optionally define an arbitrary *item separator for this section,* overriding the default [ ItemSeparatorComponent ](https://reactnative.dev/docs/sectionlist#itemseparatorcomponent) for the list. |
